...
class EngineBase(ABC):
    ...
    Also serves as a factory for creating engine instances.
    """

    @classmethod
    def create(cls, engine_type: str) -> 'EngineBase':
        """
        Factory method to create an engine instance based on the engine type.

        Args:
            engine_type: Type of engine to create (pandas, polars)
        ...
        if engine_type == "pandas":
            ...
            from core.engines.polars_engine import PolarsEngine
            return PolarsEngine()
        # Commented out for future implementation
        # elif engine_type == "pyspark":
        #     from core.engines.pyspark_engine import PySparkEngine
